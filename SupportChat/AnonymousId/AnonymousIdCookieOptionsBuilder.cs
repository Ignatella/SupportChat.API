...
namespace AnonymousId.AspNetCore.Identity.Anonymous
{
    public class AnonymousIdCookieOptionsBuilder
    {
        ...
        private const bool DEFAULT_COOKIE_HTTP_ONLY = false;
        ...
        public AnonymousIdCookieOptionsBuilder SetCustomCookieHttpOnly(bool httpOnly)
        {
        ...
        public AnonymousIdCookieOptions Build()
        {
            AnonymousIdCookieOptions options = new AnonymousIdCookieOptions
            {
                ...
                HttpOnly = cookieHttpOnly ?? DEFAULT_COOKIE_HTTP_ONLY
            };
